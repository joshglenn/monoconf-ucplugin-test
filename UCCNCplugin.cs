...
namespace Plugins
{
    public class UCCNCplugin //Class name must be UCCNCplugin to work! 
    {
        ...
        //public Mono.Zeroconf.RegisterService bonjourBrowserService = null;
        public UCCNCplugin()
        {
        ...
        {
            Console.WriteLine("UCCNCplugin Shutdown_event()");
            try
            {
                myform.Close();
            }
        ...
        public void Loop_event() 
        {
            if (loopstop)
            {
                //Console.WriteLine("loopstop is true");
                return;
            }
            ...
            if (myform == null || myform.IsDisposed)
                //Console.WriteLine("myform is disposed");
                return;
            ...
            try
            {
                ...
                //myform.labelMessage.Text = e.Message;
            }
